## Component: Scoring
Scope: Triggered by question resolution. Computes accuracy score and financial profit/loss per prediction, updates Portfolio balances, and rolls individual scores up to team scores. This is the highest-bug-risk component in your whole system, per your own roadmap, since it touches real outcomes and money-equivalent balances.
One thing I want to be upfront about rather than quietly paper over: the actual scoring formulas are still an open design question in your own docs, both your Roadmap ("this needs its own design pass, possibly its own doc, before coding") and your project brief's Section 7. So I'm writing these stories around the contract, what has to happen, when, and in what order, without inventing specific math on your behalf. Where a formula choice matters for the acceptance criteria to make sense, I'll flag it as a placeholder decision rather than picking a number for you. This component is the one I'd most recommend a short standalone design doc for before you start red-green-refactor on it, exactly like your roadmap already says.
